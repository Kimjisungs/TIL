...
예를 들어 주어진 배열이 [4, 1, 3, 2]이라면 true,
[4, 1, 3] 또는 [1, 3]이라면 false를 반환한다.

*/

function isNotOverlapArray(array) {
  const maxNumber = Math.max(...array);
  const arrayNum = array.sort((a, b) => a - b);
...
console.log(isNotOverlapArray([1, 4, 3, 2])); // true
