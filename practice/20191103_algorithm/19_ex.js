/*
  ...
  40, 42, 45, 48, 50, 54, 60, 63, 70, 72,
  80, 81, 84, 90, 100, 102, 108, 110, 111,
  112, 114, 117, 120, 126, 132, 133, 135, 140,
  144, 150, 152, 153, 156, 162, 171, 180, 190, 192, 195, 198, 200
...
function isHarshad(n) {
  const stringVal = n.toString().split('');
  let text = '';
  let num = 0;
